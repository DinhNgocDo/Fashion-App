...
View : shop-single, shop, shop-layout , form-product

Request : StoreProduct

Route : add name for all route

--15/10/2021--
View: cart, single, layout shopper, layout admin, admin order, checkout, thankyou
Controller: Order, Admin Order
Model: Order, OrderProduct
Components: Helper
Route 
Migration
--end-- 10/20/2021 : git push branch order

--22/10/2021--
View: admin-layout, admin (category, create-category, form-category, edit-category), checkout, emails(folder)
Mail:
Controller: Admin Category, Admin Product, Order
Request: FormCategory, FormProduct, Order
Model: Category
Route 
--end-- 25/10/2021
